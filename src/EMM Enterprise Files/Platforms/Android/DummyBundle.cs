...
namespace EMM_Enterprise_Files
{
    internal class DummyBundle
    {
        ...
        public static Bundle getDummyBundle()
        {
            ...
            myBundle.PutString("path", "[SPECIALFOLDER|DOWNLOAD]/CompanyPortal.apk");
            myBundle.PutString("intent", "Compliant");
            ...
            innerBundle1.PutString("path", "[SPECIALFOLDER|DOWNLOAD]/meme.jpg");
            innerBundle1.PutString("intent", "Compliant");
            ...
            innerBundle2.PutString("path", "[SPECIALFOLDER|DOWNLOAD]/monsieur.jpg");
            innerBundle2.PutString("intent", "Create");
            Bundle[] bundleArray = new Bundle[] { myBundle, innerBundle1, innerBundle2 };
